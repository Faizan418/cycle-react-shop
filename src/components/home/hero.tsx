...
export function Hero() {
  return (
    <section className="relative flex min-h-[600px] items-center overflow-hidden bg-cycle-light">
      <div className="container mx-auto px-4 py-12 lg:px-8 lg:py-16">
        <div className="relative z-10 grid gap-8 md:grid-cols-2">
          <div className="flex flex-col justify-center">
            ...
            <p className="mb-8 max-w-md text-lg text-cycle-gray">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button asChild variant="outline" className="border-cycle-dark text-cycle-dark hover:bg-cycle-dark hover:text-white">
          ...
          <div className="relative hidden md:block">
            <img
              ...
              alt="Premium bicycle"
              className="mx-auto max-h-[500px] w-auto object-cover"
            />
          </div>
        </div>
      </div>
